...
namespace GTA_V_Cleaner
{
    internal class Program
    {
        ...
        {
            "bink2w64.dll", "common.rpf", "d3dcompiler_46.dll", "d3dcsx_46.dll", "fvad.dll", "GFSDK_ShadowLib.win64.dll", "GFSDK_TXAA.win64.dll", "GFSDK_TXAA_AlphaResolve.win64",
            "GPUPerfAPIDX11-x64.dll", "GTA5.exe", "GTA5_BE.exe", "GTAVLanguageSelect.exe", "GTAVLauncher.exe", "PlayGTAV.exe", "installscript.vdf", "installscript_sdk.vdf",
            "libcurl.dll", "libtox.dll", "NvPmApi.Core.win64.dll", "opus.dll", "opusenc.dll", "steam_api64.dll", "title.rgl", "version.txt", 
            ...
            "x64o.rpf", "x64p.rpf", "x64q.rpf", "x64r.rpf", "x64s.rpf", "x64t.rpf", "x64u.rpf", "x64v.rpf", "x64w.rpf", "zlib1.dll"
        };

        // List of all default GTA V folders
        protected static readonly List<string> FOLDERS_TO_SKIP = new()
        {
            "Redistributables", "update", "x64", "Modded", "BattlEye"
        };
        #endregion
